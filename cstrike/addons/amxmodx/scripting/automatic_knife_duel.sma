...
Should a knife duel start, it works out pretty much like a round of Knife Arena: you can only use the knife.
...
#define ALLOWED_WEAPONS			1
#define KNIFESLASHES			2 // the nr of slashes within a short amount of time until a challenge starts...
// Globals below
new g_allowedWeapons[ALLOWED_WEAPONS] = {CSW_KNIFE}
new g_MAXPLAYERS
